...
# 선택 삭제
def del_file():
    #print(list_file.curselection()) #인덱스 값으로 찍힘
    #인덱스 앞부터 지우면 뒤에 인덱스값이 변경되기때문에 앞에서부터지우면 안됨 뒤에서부터지우기
...
def browse_dest_path():
    ...
    txt_dest_path.delete(0, END) # 선택된 값이 있다면 지워주고
...
txt_dest_path.pack(side="left", fill="x", expand=True, padx=5, pady=5, ipady=5) # ipady=4 높이변경
